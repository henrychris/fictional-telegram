...
namespace api.ReportClasses.BranchLevel
{
    ...
    ///</summary>
    public class BranchTanksFilled : PortraitTemplate
    {
        public Summary getPdf(string branchId, List<BranchDetails> branchDetails, List<TanksFilled> tanksFilledList, string date)
        {
            writer = new PdfWriter(pdfstream);
            // writer = new PdfWriter("./Files/PDFs/Test/branch-tanks-filled-test.pdf");
