...
namespace api.ReportClasses.BranchLevel
{
    ...
    ///</summary>
    public class BranchPosTransactions : PortraitTemplate
    {
        public Summary getPdf(string branchId, List<BranchDetails> branchDetails, List<PosTransactions> posTransactionsList)
        {
            ...
            // add items to table.
            {
                ...
                new Cell().SetBorder(Border.NO_BORDER).Add(new Paragraph($"{sn.ToString()}")));
                    ...
                    // calculates cashback charges over iterations
                ...
                // calculates failed and successful transactions
