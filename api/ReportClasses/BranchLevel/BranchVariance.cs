...
namespace api.ReportClasses.BranchLevel
{
    ...
    ///</summary>
    public class BranchVariance : PortraitTemplate
    {
        public Summary getPdf(string branchId, List<BranchDetails> branchDetails, List<Variance> varianceList)
        {
            writer = new PdfWriter(pdfstream);
            // writer = new PdfWriter("./Files/PDFs/Test/branch-variance-report-test.pdf");
